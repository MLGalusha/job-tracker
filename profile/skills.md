...
- **OpenAI API** — VTR production use of:
  ...
  - GPT-4o Vision for handwriting transcription
  - Token usage tracking and rate-limit handling
...
- **Discord webhook integrations** — google-api-tools
...
- *(None specified yet. Fill in as study guides surface gaps from JDs.)*
