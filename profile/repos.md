...
| **job-tracker** (this repo) | https://github.com/MLGalusha/job-tracker | Agent-native job search pipeline. Profile docs as source of truth, append-only JSONL queue (100+ roles), modular skills for sourcing/intake/research/tailoring. On one run, orchestrated 10 agents in parallel to build 36 application packages simultaneously. Fine to link in cover letters to agent-friendly companies. See `profile/projects/job-tracker.md`. |
