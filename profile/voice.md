...
4. **Confident about coding agents, grounded in hand-coded foundation.** Mason works primarily through Claude Code and Codex starting in 2026, and this is the differentiator, not the caveat. Never apologize for it, never hedge it, never bury it. But always pair it with the foundation: he deliberately coded by hand through all of 2025 (SonicGen, 14k LOC, zero agents) because he wanted to learn the code before he let agents write it. The transition to agents was easy because he already understood what they were producing. This sequence matters: it answers the hiring manager's unspoken question ("can this person debug when the agent is wrong?") before they ask it. Phrases he already uses: *"I built this completely solo using coding agents as my main tools."* *"I design the architecture, make the technical decisions, and use AI coding tools to accelerate implementation."* New framing to weave in when relevant: *"I coded by hand for a year before I started directing agents. The switch was easy because I already understood the code."*
