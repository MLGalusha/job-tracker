...
- **10** — dream role: lane-matched, agent-friendly signals, comp in stretch band, specific thing Mason can point to ("they use Claude Code internally", "founder's tweet about agent-directed development")
